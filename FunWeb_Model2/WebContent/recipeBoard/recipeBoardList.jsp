...
//=================================================
List<BoardBean> boardList = rbd.getBoardList(startRow,pageSize);
...
<a href="recipeBoardList.jsp?pageNum=<%=startPage-pageBlock%>">Prev</a>
	<%
}
%>
<%for (int i = startPage ; i <= endPage ; i++){ %>
	<a href="recipeBoardList.jsp?pageNum=<%=i%>"><%=i%></a>
	<%
}
if(endPage < pageCount){%>
<a href="recipeBoardList.jsp?pageNum=<%=startPage+pageBlock%>">Next</a>
	<%
	}
%>
</div>
