                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
							...
							<form action="updatePro.bo" id="update" method="post" enctype="multipart/form-data">
								...
								<div class="board-form">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control name" name="name" value="${bb.name }">
									</div>
									<div class="mb-3">
                   		...
                   		<div class="row">
                    		<div class="col-sm-12 col-md-5">
                    			<div class="btns-group">
                    				<button type="submit" form="update" class="btn btn-primary" onclick="location.href='BoardWriteForm.bo'">update</button>  
                    				<button type="button" class="btn btn-primary" onclick="location.href=document.referrer">cancel</button>
                    			</div>              			
                    		</div>
