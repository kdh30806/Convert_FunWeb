                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">답글작성</h6>
                        </div>
                        <div class="card-body">
							<div class="row"> 
                   			</div>
                   		  <div class="table-group">
							<form action="replyPro.bo" id="reply" method="post" enctype="multipart/form-data">
                   		...
                   		<div class="row">
                    		<div class="col-sm-12 col-md-5">
                    			<div class="btns-group">
                    				<button type="submit" form="reply" class="btn btn-primary" onclick="location.href='BoardWriteForm.bo'">Write</button>  
