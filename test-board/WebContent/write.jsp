                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
							...
							<form action="BoardWritePro.bo" id="write" method="post" enctype="multipart/form-data">
                   		...
                   		<div class="row">
                    		<div class="col-sm-12 col-md-5">
                    			<div class="btns-group">
                    				<button type="submit" form="write" class="btn btn-primary" onclick="location.href='BoardWriteForm.bo'">Write</button>  
