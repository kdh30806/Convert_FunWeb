...
<link href='<c:url value="https://fonts.googleapis.com/css2?family=Oswald:wght@200&family=Single+Day&display=swap"/>' rel="stylesheet">
</head>
<body>
...
<jsp:include page="../inc/top.jsp"/>
	...
	<div id="main">
		<div id="subject">
			<h2>OUTER</h2>
			<p>
				<a href='<c:url value="#"/>'>#코트/트렌치 코트</a>
				<a href='<c:url value="#"/>'>#자켓</a>
				<a href='<c:url value="#"/>'>#점퍼</a>
				<a href='<c:url value="#"/>'>#가디건</a>
				<a href='<c:url value="#"/>'>#집업</a>
				<a href='<c:url value="#"/>'>#조끼</a>
				<a href='<c:url value="#"/>'>#야상</a>
			</p>
		</div>
