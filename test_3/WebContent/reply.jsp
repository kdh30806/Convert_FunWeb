...
<body>
	<div class="main">
		<h1>답글 작성</h1>
		<form action="replyPro.bo" method="post" enctype="multipart/form-data">
		...
		<div class="btngroup">
			...
			<button type="button" class="btn btn-secondary btn-lg" onclick="location.href='detail.bo?num=${bb.num}'">취소</button>
		</div>
		</form>	
	</div>
</body>
